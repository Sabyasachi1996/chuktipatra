        ...
        <div class="card-body" id="aadhaar_request">
            <div class="row mb-3">
                <div class="col-lg-8 col-md-8">
                    ...
                    {{ Form::open(['url' => $payment_url, 'method' => 'post', 'class' => '']) }}  
                        
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                <h6 class="mb-3">You need to pay UDIN Fees of Rs {{$quotation_amount}}</h6 clas:>
                                <button type="submit" class="btn btn-primary">Pay Now</button>
                                <input type="hidden" name="esrd" value="{{$enc_payment}}">
                                <input type="hidden" name="escr" value="{{$agreement_num}}">
                            </div>
                        </div>
